...
class DashboardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dashboard" do
    assert_difference('Dashboard.count') do
      post dashboards_url, params: { dashboard: { priorities_json: @dashboard.priorities_json, query: @dashboard.query } }
    end
  ...
  test "should update dashboard" do
    patch dashboard_url(@dashboard), params: { dashboard: { priorities_json: @dashboard.priorities_json, query: @dashboard.query } }
